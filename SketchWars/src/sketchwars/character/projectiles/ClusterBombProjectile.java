 ...
 */
public class ClusterBombProjectile extends AbstractProjectile {
    private static final int TOTAL_CLUSTERS = 8;
    private static final int CLUSTER_SPEED = 500;
    
    public static final double EXPLOSION_RADIUS = 150.0;
    
    private static final double LIFESPAN_MILLIS = 4000;
    private final ProjectileFactory factory;
    private final Timer timer;
    private BufferedImage explosionAlpha;
       
    public ClusterBombProjectile(Texture texture, ProjectileFactory factory) {
    ...
    public void update(double elapsedMillis)
    {
        ...
        if(hasExpired())
        {
            factory.createClusterMunitions(owner, CLUSTER_SPEED, coll.getPosition(), TOTAL_CLUSTERS);
        }
    }
